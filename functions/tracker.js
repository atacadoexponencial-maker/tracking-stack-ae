...
export async function onRequestPost(context) {
  ...
  try {
    ...
    // sha256/normalizePhone/normalizeName moved to api/_hash.js: the
    // "EntrouGrupo" conversion hashes the same phone numbers, and two copies of
    // these rules would silently drift into treating one person as two.
